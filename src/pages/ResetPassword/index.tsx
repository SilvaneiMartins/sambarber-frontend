...
const ResetPassword: React.FC = () => {
   ...
   const handleSubimit = useCallback(async (data: ResetPasswordFormData) => {
      try {

         const schema = Yup.object().shape({
            password: Yup.string().required('A nova senha é obrigatório!'),
            password_confirmation: Yup.string().oneOf([Yup.ref('password'), null], 'Confirmação de senha estão incorreta!')
         })
